...
const df_348_1 = new (require('@comunica/logger-void').LoggerVoid)();
...
const https___linkedsoftwaredependencies_org_bundles_npm_comunica_paths__0_0_0_components_ActorQueryPath_jsonld_ActorQueryPath_default_bus = new (require('@comunica/core').Bus)({
  'name': 'https://linkedsoftwaredependencies.org/bundles/npm/comunica-paths/^0.0.0/components/ActorQueryPath.jsonld#ActorQueryPath_default_bus'
});
...
const urn_comunica_paths_query_mediators_main = new (require('@comunica/mediator-race').MediatorRace)({
  'name': 'urn:comunica:paths:query/mediators#main',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm_comunica_paths__0_0_0_components_ActorQueryPath_jsonld_ActorQueryPath_default_bus
});
...
const urn_comunica_paths_init = new (require('./dist/index.js').ActorInitQueryPaths)({
  'mediatorQueryPath': urn_comunica_paths_query_mediators_main,
...
const urn_comunica_paths_query_actors_bfs = new (require('./dist/index.js').ActorQueryPathBfs)({
  'queryProcessor': urn_comunica_default_query_process_actors_sequential,
  'mediatorRdfJoin': urn_comunica_default_rdf_join_mediators_main,
  'batchSize': 128,
  'name': 'urn:comunica:paths:query/actors#bfs',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm_comunica_paths__0_0_0_components_ActorQueryPath_jsonld_ActorQueryPath_default_bus,
  'busFailMessage': 'Path querying failed: none of the configured actors accepted the request'
});
...
const urn_comunica_default_Runner = (https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_init__5_0_0_components_ActorInit_jsonld_ActorInit_default_bus, [
  urn_comunica_paths_query_actors_bfs,
  urn_comunica_paths_init,
...
return urn_comunica_paths_init;
}
